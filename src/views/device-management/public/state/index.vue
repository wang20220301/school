    ...
    <div class="details">
      <div class="detalis-title">
        <div class="detalis-title-content">
          <p
            class="detalis-title-conten-text"
...
<script>
import Turnleft_nol from "@/icons/Turnleft_nol.png";
import Turnright_nol from "@/icons/Turnright_nol.png";
export default {
  data() {
...
.detalis-title-conten-text {
  width: 60px;
  height: 27px;
  text-align: center;
  border-bottom: 1px #5196ff solid;
  cursor: pointer;
}
.back img,
.forward img{
